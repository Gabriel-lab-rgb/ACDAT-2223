...
import com.thoughtworks.xstream.io.xml.StaxDriver;
    ...
    public class VuelosXStream {
         ...
         *
         * @param vuelos
         *            Colección de objetos de entrada de tipo Vuelo
         *
        ...
        private String serializar(Vuelos vuelos, String format) {
            ...
            try {
                ...
                contexto.alias("ListaVuelos", Vuelos.class); // Objeto Vuelos -> Elemento <Vuelos>
        ...
        public static void main(String[] args) {
            Vuelos v=new Vuelos();
            v.add(new Vuelo("Sevilla","Malaga"));
            v.add(new Vuelo("Sevilla","Madrid"));
            v.add(new Vuelo("Sevilla","Lisboa"));

            VuelosXStream serializador=new VuelosXStream();

            System.out.print(serializador.serializarJSON(v));
        }
    }
